...
function ListarFechas({fechas,mostrarClienteFecha,eliminarFecha,metodoEditarFecha,accionesModalFecha,accionesModalNotas}) {
    return (
        <div>
            <h2 className='text-center mt-2 font-bold text-pink-500 text-3xl'>FECHAS</h2>
            ...
            <div className='fixed flex justify-around animate-bounce w-full  bottom-8 '>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 26" strokeWidth={0.9} stroke="purple" className="w-12 "
            onClick={accionesModalNotas}
            >
